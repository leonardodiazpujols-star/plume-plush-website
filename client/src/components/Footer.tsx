/**
 * Footer — Plume & Plush
 * Dark charcoal background, gold accents, city strip at bottom
 */
    ...
    <footer className="bg-[oklch(0.10_0.005_285)] text-white/70">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12 py-16 grid grid-cols-1 md:grid-cols-4 gap-10">
        ...
        <div className="md:col-span-1 flex flex-col items-start gap-4">
          ...
          />
          <p
            className="text-[0.6rem] tracking-[0.25em] uppercase text-[oklch(0.72_0.09_75)]"
        ...
        {/* Navigation */}
        <div>
          <h4 className="text-[0.6rem] tracking-[0.25em] uppercase text-[oklch(0.72_0.09_75)] mb-5" style={{ fontFamily: "'Jost', sans-serif" }}>
            Navigation
          </h4>
            ...
            {["Home", "About Us", "Services", "Events", "Contact"].map((item) => (
              <li key={item}>
                <Link
                  ...
                  className="text-[0.75rem] text-white/50 hover:text-[oklch(0.72_0.09_75)] transition-colors"
        ...
        <div>
          ...
          <ul className="flex flex-col gap-3 text-[0.75rem] text-white/50" style={{ fontFamily: "'Jost', sans-serif", fontWeight: 300 }}>
            ...
            <li>
              <a href="mailto:info@plumeplush.com" className="hover:text-[oklch(0.72_0.09_75)] transition-colors">
                info@plumeplush.com
              </a>
            </li>
            <li className="mt-2 leading-relaxed">
              Plume &amp; Plush Limited<br />
              128 City Road<br />
              London EC1V 2NX
            </li>
          </ul>
        ...
        <div>
          ...
          <h4 className="text-[0.6rem] tracking-[0.25em] uppercase text-[oklch(0.72_0.09_75)] mb-4" style={{ fontFamily: "'Jost', sans-serif" }}>
            Follow
          </h4>
          <div className="flex gap-4">
            <a href="https://www.instagram.com/plume_and_plush/" target="_blank" rel="noopener noreferrer"
              className="text-white/40 hover:text-[oklch(0.72_0.09_75)] transition-colors">
              <Instagram size={18} />
            </a>
      ...
      <div className="py-5 text-center">
        <p
          className="text-[0.6rem] tracking-[0.35em] uppercase text-[oklch(0.72_0.09_75)]/60"
          style={{ fontFamily: "'Jost', sans-serif", fontWeight: 300 }}
        >
