/**
 * Services Page — Plume & Plush
 * Design: Dark Opulence × Pink Marble Editorial
 * Sections: Hero | Services Grid | Process | Brand Activations | Global | CTA
 */
...
const services = [
  ...
  },
  {
    ...
    features: [
      ...
      "Metal & Jewellery Engraving",
      "Leather Goods Personalisation",
      "Trophy & Award Engraving",
      "Architectural & Interior Pieces",
    ],
    accent: "dark",
  },
  {
  ...
  },
  {
    ...
    features: [
      "Garment & Accessory Monogramming",
      "Luxury Home Textiles",
      "Ceremonial & Uniform Embroidery",
  ...
  },
  {
    ...
    features: [
      ...
      "Furniture & Interior Gilding",
      "Ceramic & Porcelain Gilding",
      "Architectural Gilding",
      "Bespoke Object Gilding",
    ],
    accent: "pink",
  },
  {
    ...
    <div className="min-h-screen bg-[oklch(0.96_0.01_80)]" style={{ fontFamily: "'Jost', sans-serif" }}>
      ...
      >
        ...
        <div className="relative z-10 flex flex-col items-center gap-5 px-6 py-20">
          ...
          <p
            className="text-[0.75rem] tracking-[0.2em] uppercase text-white/60 max-w-lg"
      ...
      {services.map((service, i) => {
        const isEven = i % 2 === 0;
        const bgClass = service.accent === "pink"
          ? "bg-[oklch(0.96_0.01_80)]"
          : "bg-[oklch(0.12_0.005_285)]";
        ...
        const checkClass = service.accent === "dark" ? "text-[oklch(0.72_0.09_75)]" : "text-[oklch(0.72_0.09_75)]";
            ...
            <div className="max-w-7xl mx-auto px-6 lg:px-12">
              <div className={`grid grid-cols-1 lg:grid-cols-2 gap-16 items-center ${isEven ? "" : "lg:flex-row-reverse"}`}>
                ...
                <div className={`fade-up ${isEven ? "order-2 lg:order-2" : "order-2 lg:order-1"}`} style={{ transitionDelay: "120ms" }}>
                  ...
                  <h2
                    className={`text-4xl md:text-5xl ${textClass} mb-6 leading-tight`}
                    style={{ fontFamily: "'Cormorant Garamond', serif", fontWeight: 300 }}
                  >
                    {service.title}
                  </h2>
                  ...
                  <ul className="flex flex-col gap-3 mb-8">
                    {service.features.map((f) => (
                      <li key={f} className="flex items-center gap-3">
                        ...
                        <span className={`text-[0.78rem] ${subTextClass}`} style={{ fontWeight: 300 }}>
                          {f}
                        </span>
                      </li>
                    ))}
                  ...
                  <a
                    href="#contact"
                    className={service.accent === "dark" ? "btn-gold" : "btn-gold-filled"}
                  >
                    Enquire Now
                  </a>
                </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {[
              ...
              <div key={p.step} className="text-center fade-up" style={{ transitionDelay: `${i * 100}ms` }}>
                <div
                  className="text-5xl text-[oklch(0.72_0.09_75)]/30 mb-4"
                  style={{ fontFamily: "'Cormorant Garamond', serif", fontWeight: 300 }}
                >
                  {p.step}
                </div>
                <h3
                  className="text-xl text-[oklch(0.14_0.005_285)] mb-3"
                  style={{ fontFamily: "'Cormorant Garamond', serif", fontWeight: 400 }}
                >
                  {p.title}
                </h3>
                <p className="text-[0.78rem] text-[oklch(0.4_0.01_285)] leading-relaxed" style={{ fontWeight: 300 }}>
                  {p.desc}
                </p>
              </div>
            ))}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              },
              {
                city: "Milan",
                flag: "🇮🇹",
                address: "Brera Design District\nMilan, Italy",
                phone: "By appointment",
                role: "Italian Atelier",
              },
            ].map((office, i) => (
              <div
                key={office.city}
                className="border border-[oklch(0.72_0.09_75)]/20 p-6 hover:border-[oklch(0.72_0.09_75)]/60 transition-colors fade-up"
              ...
              >
                ...
                <p className="text-[0.6rem] tracking-[0.2em] uppercase text-[oklch(0.72_0.09_75)] mb-4" style={{ fontFamily: "'Jost', sans-serif" }}>
                  {office.role}
                </p>
                <p className="text-[0.75rem] text-white/50 leading-relaxed whitespace-pre-line mb-3" style={{ fontWeight: 300 }}>
                  {office.address}
                </p>
                <p className="text-[0.75rem] text-[oklch(0.72_0.09_75)]/70" style={{ fontWeight: 300 }}>
                  {office.phone}
                </p>
              </div>
            ))}
