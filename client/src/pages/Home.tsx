/**
 * Home Page — Plume & Plush
 * Design: Dark Opulence × Pink Marble Editorial
 * Sections: Hero | Editorial 3-col | Values | Signature Services | Live Sketching | Global | CTA | Footer
 */
    ...
    <div className="min-h-screen bg-[oklch(0.96_0.01_80)]" style={{ fontFamily: "'Jost', sans-serif" }}>
      ...
      >
        ...
        <div className="absolute top-20 left-0 right-0 flex justify-center gap-10 z-10 pt-4">
          {["Home", "Our Story", "Collections", "Artisans"].map((item, i) => (
            <span
              key={item}
        ...
        <div className="relative z-10 flex flex-col items-center gap-6 px-6">
          ...
          {/* Wordmark */}
          <p
            className="text-[0.65rem] tracking-[0.4em] uppercase text-[oklch(0.72_0.09_75)]"
          ...
          {/* Tagline */}
          <p
            className="text-[0.7rem] tracking-[0.25em] uppercase text-white/70"
      ...
      {/* ═══════════════════════════════════════════════
          EDITORIAL 3-COL — Cream background
      ═══════════════════════════════════════════════ */}
      <section className="bg-[oklch(0.96_0.01_80)] py-20">
        <div className="max-w-7xl mx-auto px-6 lg:px-12 grid grid-cols-1 md:grid-cols-3 gap-0 divide-x divide-[oklch(0.88_0.01_75)]">
          ...
          <div className="px-8 py-4 fade-up">
            ...
            <h2
              className="text-3xl text-[oklch(0.14_0.005_285)] mb-3 leading-tight"
          ...
          {/* Col 2 — Engraved with Distinction */}
          ...
          <div className="px-8 py-4 fade-up" style={{ transitionDelay: "200ms" }}>
            ...
            <p className="text-[0.8rem] text-[oklch(0.4_0.01_285)] leading-relaxed mb-5" style={{ fontWeight: 300 }}>
              A global perspective shapes our creations, while local traditions inspire our craftsmanship. Offices in London, Dubai, Paris &amp; Milan.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12 grid grid-cols-2 md:grid-cols-4 divide-x divide-[oklch(0.88_0.01_75)]">
          {[
            ...
            <div key={v.title} className="px-8 py-8 text-center fade-up" style={{ transitionDelay: `${i * 80}ms` }}>
              ...
              <h3
                className="text-[0.65rem] tracking-[0.2em] uppercase text-[oklch(0.14_0.005_285)] mb-3"
                style={{ fontFamily: "'Jost', sans-serif", fontWeight: 500 }}
              >
                {v.title}
              </h3>
              <p className="text-[0.75rem] text-[oklch(0.5_0.01_285)] leading-relaxed" style={{ fontWeight: 300 }}>
                {v.desc}
              </p>
            </div>
          ))}
      ...
      {/* ═══════════════════════════════════════════════
          LIVE SKETCHING FEATURE — Pink Marble
      ═══════════════════════════════════════════════ */}
      <section
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative fade-up" style={{ transitionDelay: "150ms" }}>
              ...
              />
              <div
                className="absolute -bottom-6 -left-6 bg-[oklch(0.14_0.005_285)] p-6 max-w-[220px]"
              >
                <p className="text-[oklch(0.72_0.09_75)] text-[0.6rem] tracking-[0.2em] uppercase mb-2" style={{ fontFamily: "'Jost', sans-serif" }}>
                  Our Promise
                </p>
                <p
                  className="text-white text-xl leading-snug italic"
                  style={{ fontFamily: "'Cormorant Garamond', serif", fontWeight: 300 }}
                >
      ...
      {/* ═══════════════════════════════════════════════
          SIGNATURE SERVICES — Dark Charcoal
      ═══════════════════════════════════════════════ */}
            ...
            {[
              ...
              >
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6">
                  ...
                  <p className="text-[0.75rem] text-white/60 leading-relaxed" style={{ fontWeight: 300 }}>
                    {s.desc}
                  </p>
                </div>
              </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="fade-up">
              ...
              <p className="text-[0.85rem] text-[oklch(0.4_0.01_285)] leading-relaxed mb-8 max-w-md" style={{ fontWeight: 300 }}>
                From our headquarters in London to our studios in Dubai, Paris, and Milan — Plume &amp; Plush brings world-class artisanship to wherever you are. We serve luxury brands, five-star hotels, and discerning private clients across five continents.
              </p>
              <div className="grid grid-cols-2 gap-4">
                {[
                  ...
                  <div key={loc.city} className="border-l-2 border-[oklch(0.72_0.09_75)] pl-4">
                    <p
                      className="text-[0.65rem] tracking-[0.2em] uppercase text-[oklch(0.72_0.09_75)] mb-1"
                      style={{ fontFamily: "'Jost', sans-serif", fontWeight: 500 }}
                    >
                      {loc.city}
                    </p>
                    <p className="text-[0.75rem] text-[oklch(0.5_0.01_285)]" style={{ fontWeight: 300 }}>
                      {loc.detail}
                    </p>
                  </div>
                ))}
      ...
      >
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center fade-up">
          ...
          <h2
            className="text-4xl md:text-5xl text-white mb-6 leading-relaxed italic"
            style={{ fontFamily: "'Cormorant Garamond', serif", fontWeight: 300 }}
          >
      ...
      <section id="contact" className="bg-[oklch(0.96_0.01_80)] py-20">
        <div className="max-w-3xl mx-auto px-6 text-center fade-up">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="mailto:info@plumeplush.com" className="btn-gold-filled">
              Email Us
            </a>
            <a href="tel:+447415202350" className="btn-gold">
              Call London
            </a>
          </div>
        </div>
